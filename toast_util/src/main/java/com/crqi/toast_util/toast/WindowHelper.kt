...
internal class WindowHelper(// 用于 Activity 暂停时移除 WindowManager
    private var mToastHelper: ToastHelper, application: Application) : Application.ActivityLifecycleCallbacks {
